"""Provides a C-like array structure intended to practice developing foundational
data structures such as resizing arrays."""

__author__ = "Peter Drake and Colin Ehr"
